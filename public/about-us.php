            ...
            <ul class='list'>
                <li class='item'>
                    ...
                    <label class='label_strawberry'
                           for='radio_The garden strawberry (or simply strawberry /ˈstrɔːbᵊri/; Fragaria × ananassa) is a widely grown hybrid species of the genus Fragaria (collectively known as the strawberries)'>Daniel Alonso</label>
                ...
                <li class='item'>
                    ...
                    <label class='label_banana'
                           for='radio_A banana is an edible fruit, botanically a berry, produced by several kinds of large herbaceous flowering plants in the genus Musa.'>Miguel Martínez</label>
                ...
                <li class='item'>
                    ...
                    <label class='label_apple'
                           for='radio_The apple tree (Malus domestica) is a deciduous tree in the rose family best known for its sweet, pomaceous fruit, the apple. It is cultivated worldwide as a fruit tree, and is the most widely grown species in the genus Malus.'>Maksym Dovgam</label>
                    <div class='content content_apple'><span class='picto'></span>
                        <h1>Maksym Dovgam</h1>
                        <p>Este es Maksym Dovgam</p>
                    </div>
                </li>
                <li class='item'>
                    <input type='radio'
                    ...
                    <label class='label_orange'
                           for='radio_The orange (specifically, the sweet orange) is the fruit of the citrus species Citrus × sinensis in the family Rutaceae.'>Víctor Hellín</label>
