...
<html lang="es">
<head>
    <!-- Metas dela página HTML -->
    <meta content="text/html;charset=UTF-8" http-equiv="Content-Type">
    <meta content="PÁGINA DE PRUEBAS EN PHP" name="description">
    ...
    <meta property="og:description" content="PÁGINA DE PRUEBAS EN PHP">
...
<main>
    ...
    <footer>
        <p>&copy; 2023 AsynCore. Todos los derechos reservados.</p>
    </footer>
</main>
</body>
</html>