<?php
     ...
     * @return string
     */
    function jsRedirectToLogin(string $registerEmail, string $registerPassword, string $message): string
    {
    ...
    if($_SERVER["REQUEST_METHOD"] == METHOD_POST && $_POST['form'] == ACTIVE_TAB_DEFAULT){
        ...
        if($loginEmailError == EMPTY_STRING && $loginPasswordError == EMPTY_STRING && ($loginCheck == CHECKED) && !$success){
    ...
    if($_SERVER["REQUEST_METHOD"] == METHOD_POST && $_POST['form'] == ACTIVE_TAB_REGISTER){
        ...
        $errores = [$registerNameError, $registerUserNameError, $registerEmailError, $registerPasswordError,
        ...
        HTML;
        echo jsRedirectToLogin($registerEmail, $registerPassword, $message);
        exit;
        }
    }