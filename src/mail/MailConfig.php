<?php
     ...
     * @package  src\db
     */
    class MailConfig extends Singleton
    {
        /**
         * @var array $config Array donde se almacenarán los datos de
         *                    configuración de la base de datos.
         */
        private array $config;
        
        /**
         * Construye un objeto DatabaseConfig y carga el array de configuración
         * de la base de datos.
         *
        ...
        /**
         * Función que devuelve el array con los parámetros de configuración
         * dependiendo del tipo de conexión que se le pase. Si no existe el
         * tipo de conexión, devuelve NULL.
         *
